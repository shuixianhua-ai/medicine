...
import { Form, Table, Input, Button, Space, Row, Col, Checkbox, Divider, Upload ,Modal,Radio} from 'antd'
  ...
  render() {
    const columns = [
      ...
      },
      {
        ...
        render: (text, record) => (
            <Space size="middle">
              <a onClick={()=>this.changeInfo(record.name)}>修改</a>
            </Space>
        )
      },
    ];
        ...
        <div>
            ...
            <Modal
                    ...
                    <div className='myregister'>
                        <div className='registitle' style={{width:"80%",display:"flex",justifyContent:'center'}}>{"修改用户:"+this.state.selectedUser+"的权限"}</div>
                        <Form
                            name="changeIdentity"
