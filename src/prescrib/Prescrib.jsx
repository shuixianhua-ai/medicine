...
class Prescription extends Component {
	...
	render() {
		const { dataSource, loading, selectedRowKeys,medList ,choicelist,medIcon,medNameZh,otherinformation,doctor_id,doctor_name,user_age,user_gender,user_id} = this.state;
		const rowSelection = {
			type: 'radio',
			selectedRowKeys,
							...
							<div class="prescribbox">
								<div class="presentbox">
									...
									<div class="basicbox1">
										...
										<label class="underline1" >{user_id}</label>

										<div class="labeltext_5">
											性别：
						         </div>
										<label class="underline2" >{user_gender}</label>
									...
									<div class="basicbox2">
										...
										<TextArea rows={4} className="describe" onChange={(e)=>{this.setState({information:e.target.value})}}/>
